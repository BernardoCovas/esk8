...
void test_e_skate_uart_msg_find_header()
{
    ...
    int res1 = e_skate_uart_msg_find_header(some_header_at_0     , sizeof(some_header_at_0)   );
    int res2 = e_skate_uart_msg_find_header(some_header_at_4     , sizeof(some_header_at_4)   );
    int res3 = e_skate_uart_msg_find_header(some_header_at_neg1  , sizeof(some_header_at_neg1));
