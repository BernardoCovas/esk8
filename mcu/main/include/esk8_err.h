...
typedef enum esk8_err_t
{
    ...
    ESK8_ERR_BLE_INIT_NOINIT,                 /* Not initialized */
    ESK8_ERR_BLE_INIT_REINIT,                 /* Already had been initialized */
    ESK8_ERR_BLE_INIT_FAILED,
    ESK8_ERR_BLE_INIT_MAXREG,                 /* Maximum number of registed apps reached */
    ESK8_ERR_BLE_NOTF_TIMEOUT,
    ESK8_ERR_BLE_APP_NOREG,                   /* App not registered */
